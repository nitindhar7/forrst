...
public class ForrstAPIClient implements ForrstAPI {
    ...
    public Stat stats() {
        ...
        try {
            stat = mapper.readValue(http.get(Endpoint.getInstance().STATS_URI, ABSENT).toString(), Stat.class);
        } catch (Exception e) {
    ...
    public User usersInfo(Map<String,String> userInfo) {
		...
		try {
		    if(userInfo.containsKey("id") || userInfo.containsKey("username")) {
                user = mapper.readValue(http.get(Endpoint.getInstance().USERS_INFO_URI, Optional.fromNullable(userInfo)).toString(), User.class);
            }
        } catch (Exception e) {
    ...
    public Post postsShow(int id) {
	    ...
	    try {
	        ...
	        post = mapper.readValue(http.get(Endpoint.getInstance().POSTS_SHOW_URI, Optional.fromNullable(params)).toString(), Post.class);
	    } catch (Exception e) {
